...
if [ $IMAGE_EXIST -ne 1 ]; then
    ...
    mkfs.ext4 -q -I $IMAGE_INODE_SIZE -N $IMAGE_INODE_COUNT $IMAGE_ARCHIVE || fail "Creating filesystem"
    echo "OK"
fi
...
"$SOURCE_DIR/Scripts/SetupRootFilesystem.sh"